...
class ActuatorAdapterManager(object):
	...
	def _initEnvironmentalActuationTasks(self):
		"""
		Create simulator datasets for humidity, pressure and temperature sensors, by
		either using an emulator or
		setting the floor and ceiling values and generating simple sine wave values
		by invoking SensorDataGenerator instance.
	...
	def sendActuatorCommand(self, data: ActuatorData) -> bool:
		"""
		Triggers actuation based on the data being passed.
	...
	def setDataMessageListener(self, listener: IDataMessageListener) -> bool:
		"""
		Setter for the IDataMessageListener instance.
